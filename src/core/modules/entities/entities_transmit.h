...
//-----------------------------------------------------------------------------
namespace boost {
	inline std::size_t hash_value(TransmitPair_t const &p) {
		std::size_t s = 0;
...
typedef boost::unordered_set<TransmitPair_t, boost::hash<TransmitPair_t>, TransmitPairEquals_t> TransmitPairs_t;
